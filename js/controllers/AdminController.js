...
export class AdminController {
          ...
          <form id="addProductForm" class="admin-modal__body">
            ...
            <div class="form-group">
              ...
              <select id="productCategory" name="category" required class="form-select">
                ...
                <option value="tikka_set">Tikka Set</option>
                <option value="payals">Payals</option>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea id="productDescription" name="description" rows="4" class="form-textarea"></textarea>
            </div>
            <div class="form-group">
              <label for="productImage">Image URL</label>
              <input type="url" id="productImage" name="image_url" class="form-input" placeholder="https://...">
            </div>
  ...
  showAddPromoModal() {
    ...
    if (!modal) {
      ...
      form.addEventListener('submit', (e) => this.handleAddPromo(e));
  ...
  async handleAddProduct(event) {
    ...
    const productData = {
      ...
      image_url: formData.get('image_url') ? [formData.get('image_url')] : []
    };
