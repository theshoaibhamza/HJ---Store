...
export class AuthController {
  ...
  async handleLogin(event) {
    ...
    try {
      ...
      this.showFormSuccess(form, 'Login successful! Redirecting...');

      // Wait a moment to show the message
      await new Promise(resolve => setTimeout(resolve, 1000));

      // Extract user from nested response (backend returns { data: { user, token } })
      ...
      if (userData && (userData.role === 'admin' || userData.isAdmin === true)) {
        ...
        // Always redirect to home page after login (not to cart to avoid timing issues)
  ...
  async handleRegister(event) {
    ...
    try {
      ...
      // Show success message
      this.showFormSuccess(form, 'Registration successful! Redirecting to login...');
  ...
  showFormError(form, message) {
    ...
    if (!errorElement) {
      ...
      errorElement.setAttribute('style', 'background: #f8d7da !important; border: 1px solid #f5c6cb !important; color: #721c24 !important; padding: 0.75rem !important; border-radius: 4px !important; margin-bottom: 1rem !important; display: block !important; font-size: 0.9rem !important; position: relative !important; z-index: 9999 !important; width: 100% !important; box-sizing: border-box !important; visibility: visible !important; opacity: 1 !important;');
  ...
  showFormSuccess(form, message) {
    ...
    if (!successElement) {
      ...
      successElement.setAttribute('style', 'background: #d4edda !important; border: 1px solid #c3e6cb !important; color: #155724 !important; padding: 0.75rem !important; border-radius: 4px !important; margin-bottom: 1rem !important; display: block !important; font-size: 0.9rem !important; position: relative !important; z-index: 9999 !important; width: 100% !important; box-sizing: border-box !important; visibility: visible !important; opacity: 1 !important;');
  ...
  requireAuth() {
    ...
    console.log('isLoggedIn():', userModel.isLoggedIn());
